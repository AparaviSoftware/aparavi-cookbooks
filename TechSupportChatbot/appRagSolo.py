...
if prompt := st.chat_input("Hi there! I am your virtual Hult Tech Ambassador.  How can I help?"):
    ...
    # Get the vectors
    queryVectors = model.encode(prompt, show_progress_bar = False)

    # perform semantic search 
    semanticResponse = Qdrantclient.search(
        collection_name="HultTechSupportv1", query_vector=queryVectors    , limit=5
    )
